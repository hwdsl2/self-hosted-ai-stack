...
- [ ] I ran `./stack-check.sh` for service wiring or health-check changes, or explained why not.
- [ ] I did not include API keys, provider credentials, private prompts, private documents, model files, or private data.
