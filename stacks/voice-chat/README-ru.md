...
> **Совет:** При предоставлении доступа к AnythingLLM за пределами `localhost` или доверенной локальной сети размещайте его за обратным прокси с TLS, чтобы пароль шифровался при передаче. См. ниже [Использование обратного прокси](#использование-обратного-прокси).
